...
actual_values_2013 <- nitrate_data %>%
...
ggplot(anomalies, aes(x = Month, y = Depth, fill = Anomaly)) +
  ...
  scale_fill_stepsn(colors = custom_palette,
                    ...
                    oob = scales::squish,
                    name = "Anomaly (µmol/L)") +
  labs(x = "Month", y = "Depth (m)", title = "Nitrate Concentration Anomalies (2013)") +
  theme_minimal() +
...
# Plot the anomalies with values
ggplot(anomalies, aes(x = Month, y = Depth, fill = Anomaly)) +
  geom_tile(color = "white") +
...
actual_values_april_2013 <- nitrate_data %>%
...
ggplot(anomalies_april_2013, aes(x = as.factor(Day), y = Depth, fill = Anomaly)) +
  ...
  scale_fill_stepsn(colors = custom_palette,
                    ...
                    oob = scales::squish,
                    name = "Anomaly (µmol/L)") +
  labs(x = "Day", y = "Depth (m)", title = "Nitrate Concentration Anomalies (April 2013)") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        legend.position = "right",
        legend.key.width = unit(1, "cm"), 
...
actual_values_2014 <- nitrate_data %>%
...
ggplot(anomalies, aes(x = Month, y = Depth, fill = Anomaly)) +
  ...
  scale_fill_stepsn(colors = custom_palette,
                    ...
                    oob = scales::squish,
                    name = "Anomaly (µmol/L)") +
  labs(x = "Month", y = "Depth (m)", title = "Nitrate Concentration Anomalies (2014)") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        legend.position = "right",
        legend.key.width = unit(1, "cm"), 
...
ggplot(anomalies, aes(x = Month, y = Depth, fill = Anomaly)) +
  geom_tile(color = "white") +
  geom_text(aes(label = round(Anomaly, 2)), size = 2.5, color = "black") +
  scale_fill_stepsn(colors = custom_palette,
                    breaks = breaks,
                    limits = c(-5.5, 5.5),
                    oob = scales::squish,
...
actual_values_april_2014 <- nitrate_data %>%
...
ggplot(anomalies_april_2014, aes(x = as.factor(Day), y = Depth, fill = Anomaly)) +
  ...
  scale_fill_stepsn(colors = custom_palette,
                    ...
                    oob = scales::squish,
                    name = "Anomaly (µmol/L)") +
  labs(x = "Day", y = "Depth (m)", title = "Nitrate Concentration Anomalies (April 2014)") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        legend.position = "right",
        legend.key.width = unit(1, "cm"), 
...
actual_values_october_2014 <- nitrate_data %>%
...
ggplot(anomalies_october_2014, aes(x = as.factor(Day), y = Depth, fill = Anomaly)) +
  ...
  scale_fill_stepsn(colors = custom_palette,
                    ...
                    oob = scales::squish,
                    name = "Anomaly (µmol/L)") +
  labs(x = "Day", y = "Depth (m)", title = "Nitrate Concentration Anomalies (October 2014)") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        legend.position = "right",
        legend.key.width = unit(1, "cm"), 
...
actual_values_2015 <- nitrate_data %>%
...
ggplot(anomalies, aes(x = Month, y = Depth, fill = Anomaly)) +
  ...
  scale_fill_stepsn(colors = custom_palette,
                    ...
                    oob = scales::squish,
                    name = "Anomaly (µmol/L)") +
  labs(x = "Month", y = "Depth (m)", title = "Nitrate Concentration Anomalies (2015)") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        legend.position = "right",
        legend.key.width = unit(1, "cm"), 
...
ggplot(anomalies, aes(x = Month, y = Depth, fill = Anomaly)) +
  geom_tile(color = "white") +
  geom_text(aes(label = round(Anomaly, 1)), size = 3) +  # Add text labels
  scale_fill_stepsn(colors = custom_palette,
                    breaks = breaks,
                    limits = c(-5.5, 5.5),
                    oob = scales::squish,
...
actual_values_october_2015 <- nitrate_data %>%
...
ggplot(anomalies_october_2015, aes(x = as.factor(Day), y = Depth, fill = Anomaly)) +
  ...
  scale_fill_stepsn(colors = custom_palette,
                    ...
                    oob = scales::squish,
                    name = "Anomaly (µmol/L)") +
  labs(x = "Day", y = "Depth (m)", title = "Nitrate Concentration Anomalies (October 2015)") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        legend.position = "right",
        legend.key.width = unit(1, "cm"), 
...
actual_values_2016 <- nitrate_data %>%
...
ggplot(anomalies, aes(x = Month, y = Depth, fill = Anomaly)) +
  ...
  scale_fill_stepsn(colors = custom_palette,
                    ...
                    oob = scales::squish,
                    name = "Anomaly (µmol/L)") +
  labs(x = "Month", y = "Depth (m)", title = "Nitrate Concentration Anomalies (2016)") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        legend.position = "right",
        legend.key.width = unit(1, "cm"), 
...
ggplot(anomalies, aes(x = Month, y = Depth, fill = Anomaly)) +
  geom_tile(color = "white") +
  geom_text(aes(label = round(Anomaly, 1)), size = 2) +
  scale_fill_stepsn(colors = custom_palette,
                    breaks = breaks,
                    limits = c(-5.5, 5.5),
                    oob = scales::squish,
...
actual_values_september_2016 <- nitrate_data %>%
...
# Extract unique days for September 27, 2016 to display on the x-axis
...
ggplot(anomalies_september_2016, aes(x = as.factor(Day), y = Depth, fill = Anomaly)) +
  ...
  scale_fill_stepsn(colors = custom_palette,
                    ...
                    oob = scales::squish,
                    name = "Anomaly (µmol/L)") +
  labs(x = "Day", y = "Depth (m)", title = "Nitrate Concentration Anomalies (September 27, 2016)") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        legend.position = "right",
        legend.key.width = unit(1, "cm"), 
...
actual_values_2019 <- nitrate_data %>%
...
ggplot(anomalies, aes(x = Month, y = Depth, fill = Anomaly)) +
  ...
  scale_fill_stepsn(colors = custom_palette,
                    ...
                    oob = scales::squish,
                    name = "Anomaly (µmol/L)") +
  labs(x = "Month", y = "Depth (m)", title = "Nitrate Concentration Anomalies (2019)") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        legend.position = "right",
        legend.key.width = unit(1, "cm"), 
...
actual_values_may_2019 <- nitrate_data %>%
...
# Extract unique days for May 23, 2019 to display on the x-axis
...
ggplot(anomalies_may_2019, aes(x = as.factor(Day), y = Depth, fill = Anomaly)) +
  ...
  scale_fill_stepsn(colors = custom_palette,
                    ...
                    oob = scales::squish,
                    name = "Anomaly (µmol/L)") +
  labs(x = "Day", y = "Depth (m)", title = "Nitrate Concentration Anomalies (May 23, 2019)") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        legend.position = "right",
        legend.key.width = unit(1, "cm"), 
